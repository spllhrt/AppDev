...
const getWindyMapHTML = (isFullscreen = false) => {
  ...
  // Get current weather data for popup
...
<body>
  ...
  <script>
    ...
    function createWeatherPopup() {
      const weatherData = ${JSON.stringify(currentWeather)};
      if (!weatherData) return '<div class="weather-popup"><h3>Weather Data</h3><p>Loading weather information...</p></div>';
    ...
    const options = {
      key: 'hoJfWD9PMGa5LzrkrHR8y51lleNLTBpy',
      lat: ${lat},
      lon: ${lon},
      zoom: ${zoom},
      marker: false
    ...
    windyInit(options, windyAPI => {
      ...
      marker.bindPopup(createWeatherPopup(), {
        maxWidth: 300,
        closeButton: true,
        autoClose: false,
        closeOnClick: false,
      ...
      // Auto-open popup in fullscreen mode
      ${isFullscreen ? 'setTimeout(() => marker.openPopup(), 500);' : ''}
  ...
  const displayDays = viewMode === '7day' ? 7 : 14;
          ...
          >
            ...
            <View style={styles.card}>
              <View style={styles.locationHeader}>
                <Ionicons name={useGPS ? "location" : "business"} size={16} color="#00E676" />
            ...
            <View style={styles.toggleContainer}>
              <TouchableOpacity
                style={[styles.toggleButton, viewMode === '7day' && styles.activeToggle]}
                onPress={() => setViewMode('7day')}
              >
                <Text style={[styles.toggleText, viewMode === '7day' && styles.activeToggleText]}>7 Days</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[styles.toggleButton, viewMode === '14day' && styles.activeToggle]}
                onPress={() => setViewMode('14day')}
              >
                <Text style={[styles.toggleText, viewMode === '14day' && styles.activeToggleText]}>14 Days</Text>
              </TouchableOpacity>
            </View>
